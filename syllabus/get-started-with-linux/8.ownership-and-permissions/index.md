...
permalink: /get-started-with-linux/ownership-and-permissions/
prev_link: /get-started-with-linux/user-and-group-management/sudo-and-su/
disable_toc: true
---

# Welcome to the section "File ownership and permissions"

In this section, we will understand the concept of file ownership and permissions.

We will see the different kind of file ownership and how to manage them.

At the end, we will learn the file permission system in Linux and its working.
